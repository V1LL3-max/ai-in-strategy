...
name: ai-in-strategy
description: >
  Diagnostic skill for anyone doing strategy, or strategy related research, insights, and innovation work — consultants, clients, collaborators, and strategic leaders — deciding when to use LLMs and when not to. Trigger this skill whenever the user asks "should I use AI for this", "where does AI help in strategy work", "is this a good use case for AI", "when does AI hurt more than it helps in strategy, "should I prompt this or think it through myself", or any variation of "is AI appropriate here." Also trigger when the user describes a strategy task or workflow and implicitly needs guidance on where human cognition is load-bearing vs where AI can take over — for example when discussing market research, positioning, scenario planning, client analysis, concept generation, or any stage of strategy development.
---
